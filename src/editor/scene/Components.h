...
namespace editor
{
    struct TransformComponent : engine::IJsonSerializable
    {
    ...
    struct RaytracedMaterialComponent : engine::IJsonSerializable
    {
    ...
    struct RaytracedSphereComponent : engine::IJsonSerializable
    {
