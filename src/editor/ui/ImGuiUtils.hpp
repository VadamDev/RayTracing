...
namespace editor
{
    inline void beginDisableIf(const bool disabled, const std::function<void()> &task)
    {
    ...
    */
    ...
    inline int PushDisableRounding()
    {
    ...
    inline int PushDisableSpacing()
    {
        ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing, { 0, 0 });
        return 1;
    }

    inline ImVec2 calculateButtonSize()
    {
    ...
    inline int BeginColumnAlignedControl(const std::string &label, const float columnWidth)
    {
    ...
    inline void EndColumnAlignedControl(const int disableStyles)
    {
        ImGui::Columns(1);
    ...
    inline bool Checkbox(const std::string &label, bool &value, const float columnWidth = 96.0f)
    {
    ...
    inline bool Drag1i(const std::string &label, int &value, const int speed = 1, const int min = 0, const int max = 0, const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
    ...
    inline bool Drag1f(const std::string &label, float &value, const float speed = 1, const float min = 0, const float max = 0, const char *format = "%.3f", const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
    ...
    inline bool Drag3f(const std::string &label, glm::vec3 &values, const float speed = 1, const float min = 0, const float max = 0, const char *format = "%.3f", const float defaultValue = 0.0, const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
    ...
    inline bool DragLinked3f(const std::string &label, glm::vec3 &values, bool &linked, const float speed = 1, const float min = 0, const float max = 0, const char *format = "%.3f", const float defaultValue = 0.0, const float columnWidth = 96.0f)
    {
        /*
    ...
    inline bool Color3f(const std::string &label, glm::vec3 &value, const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
    ...
    inline bool InputText(const std::string &label, std::string &value, const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
    ...
    inline bool Combo(const std::string &label, int *currentItem, const std::vector<const char*> &items, const float columnWidth = 96.0f)
    {
        const int disabledStyles = BeginColumnAlignedControl(label, columnWidth);
